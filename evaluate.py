...
#can be deleted. i left it here for a possible debugging session
#def evaluate_material(bb_material:main.BitboardChess):
#    material_value = 0
#    for piece in bb_material.piece_bitboards[bb_material.current_player]:
#        print(f"bin(bb_material.piece_bitboards[bb_material.current_player][{piece}]): {bin(bb_material.piece_bitboards[bb_material.current_player][piece])}")
#        times = count_ones(bb_material.piece_bitboards[bb_material.current_player][piece])
#        print(f"times: {times}")
#        print(f"piece_values[piece]:{piece_values[piece]}")
#        print(f"material_value before the value of {piece} is added: {material_value}")
#        material_value += piece_values[piece]*times
#        print(f"material_value after the value of {piece} is added: {material_value}")
