...
white_pieces[PAWN] = squares['a2'] | squares['b2'] | squares['c2'] | squares['d2'] | squares['e2'] | squares['f2'] | squares['g2'] | squares['h2']
white_pieces[KNIGHT] = squares['b1'] | squares['g1']
white_pieces[BISHOP] = squares['c1'] | squares['f1']
white_pieces[ROOK] = squares['a1'] | squares['h1']
white_pieces[QUEEN] = squares['d1']
white_pieces[KING] = squares['e1']

black_pieces[PAWN] = squares['a7'] | squares['b7'] | squares['c7'] | squares['d7'] | squares['e7'] | squares['f7'] | squares['g7'] | squares['h7']
black_pieces[KNIGHT] = squares['b8'] | squares['g8']
black_pieces[BISHOP] = squares['c8'] | squares['f8']
black_pieces[ROOK] = squares['a8'] | squares['h8']
black_pieces[QUEEN] = squares['d8']
black_pieces[KING] = squares['e8']

# Define functions to manipulate bitboards
def empty_bitboard():
    return 0
...
def is_square_set(bitboard, square):
    return bool(bitboard & squares[square])
