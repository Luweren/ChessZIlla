...
class BitboardChess:
    ...
    def get_king_check(self):
        ...
        print(self.king_check)
        moves = chess.generate_all_opponent_moves()

        for move in moves:
            if self.get_square_name(self.piece_bitboards[self.current_player][self.KING]) in move[1]:
                print("CHECK")
                return 1
        return 0
    ...
    def generate_king_moves(self, square):
        ...
        for direction in directions:
            ...
            if self.king_check == True or self.get_king_check():
...
chess = BitboardChess()
fen = 'rnbqkbnr/pppppppp/8/8/8/4r3/PPPP1PPP/RNBQKBNR w KQkq - 0 1'
